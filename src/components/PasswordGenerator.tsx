...
const PasswordGenerator: React.FC<PasswordGeneratorProps> = ({
	...
	const [letterCase, setLetterCase] = useState<CaseVariants>(
		CaseVariants.random,
	);
	...
	return (
		<div>
			<div className="flex flex-col gap-2 border border-indigo-600 p-2">
				...
				<Toggler isChecked={includeLetters} onChange={setIncludeLetters}>
					Использовать буквы
				</Toggler>
				<Toggler isChecked={includeNumbers} onChange={setIncludeNumbers}>
					Использовать цифры
				</Toggler>
				<Toggler isChecked={includeSymbols} onChange={setIncludeSymbols}>
