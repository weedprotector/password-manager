    ...
    return (
        <form>
            <div className="relative flex items-center max-w-[11rem]">
                ...
                <input type="text" className="bg-gray-50 border-x-0 border-gray-300 h-11 font-medium text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full " value={value} required />
                <button onClick={() => onSetState((prev) => prev+=1)} type="button" className="bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-e-lg p-3 h-11 focus:ring-gray-100 focus:ring-2 focus:outline-none">
